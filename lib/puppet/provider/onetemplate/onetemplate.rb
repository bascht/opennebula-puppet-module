  ...
  def self.instances
    ...
    REXML::Document.new(output).elements.collect("VMTEMPLATE_POOL/VMTEMPLATE") do |template|
      ...
      new(
        ...
        :disks                     => (elements["TEMPLATE/DISK/IMAGE"].to_a unless elements["TEMPLATE/DISK/IMAGE"].nil?),
        ...
        :nics                      => (elements["TEMPLATE/NIC/NETWORK"].to_a unless elements["TEMPLATE/NIC/NETWORK"].nil?),
